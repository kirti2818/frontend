  ...
  return (
    <section className="flex-1 min-h-0 flex flex-col bg-white/40 dark:bg-black/20 overflow-hidden">
      ...
      <div className="sticky top-0 z-10 flex items-center gap-3 px-3 sm:px-4 py-3 border-b border-gray-200/40 dark:border-gray-700/40 bg-white/70 dark:bg-black/50 backdrop-blur">
        <div className="h-9 w-9 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-xs font-medium">AJ</div>
        <div className="min-w-0">
          <div className="font-medium text-sm sm:text-base truncate">Alice Johnson</div>
      ...
      <div className="px-3 sm:px-4 py-3 border-t border-gray-200/40 dark:border-gray-700/40">
        <div className="flex items-center gap-2">
          ...
          <input className="flex-1 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-transparent outline-none text-sm" placeholder="Type a message" readOnly />
          <button className="px-3 py-2 rounded-lg bg-blue-600 text-white text-sm" type="button" aria-label="Send">Send</button>
        </div>
      </div>
    </section>
  )

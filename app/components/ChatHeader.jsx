...
import useCommon from '../(private)';
import { useState } from 'react';

const ChatHeader = () => {
  const {handleRouteToChatPage,isSearchPage,handleRouteToSearchPage,handleSearchInput} = useCommon()
    ...
    <header className="w-full border-b border-gray-200/40 dark:border-gray-700/40 bg-white/60 dark:bg-black/40 backdrop-blur sticky top-0 z-10" style={{ height: 'var(--header-h)' }}>
      <div className="mx-auto max-w-7xl h-full px-3 sm:px-4 lg:px-6 flex items-center gap-3">
        ...
        <div className="flex items-center gap-3 ml-2">
          ...
          {/* Settings icon */}
          <Link href="/settings" className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="Settings">
